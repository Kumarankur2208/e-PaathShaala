                ...
                <div className="swiper-wrapper">
                  <div className="box">
                    ...
                    <div className="content">
                      <p>
                        It was a nice experience and had a good and clear cut
                        view on the topics. deep learning for lifetime.
                      </p>
                      <h3>Bhavit Rathod</h3>
                      <div className="stars">
              ...
              <div className=" reviews-slider">
                <div className="swiper-wrapper">
                  <div className="box">
                    ...
                    <div className="content">
                      <p>
                        e-Path-shala is an excellent website which has almost
                        all the course one can think of at a very reasonable
                        pricing from industry experts
                      </p>
                      <h3>Gaurav More</h3>
                      <div className="stars">
                        <i className="fas fa-star" />
                  ...
                  <div className="box">
                    ...
                    <div className="content">
                      <p>
                        ...
                        empower students to study at their ownpace in and
                        outside of the classroom.e-Path-shala focus on skill
                        mastery to help learners establish strong foundations,
                        so there is no limit to what they can learn next.
                      </p>
                      <h3>Omkar Bhojane</h3>
                      <div className="stars">
                        <i className="fas fa-star" />
